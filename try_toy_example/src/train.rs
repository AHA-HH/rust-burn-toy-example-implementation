...
//     // let uxx_pred = d2_matrix.clone().matmul(u_pred.clone());
...
//     // let x_cheb_tensor = cheb_points_tensor::<Autodiff<B>>(device, 90);
//     // let x_cheb_tensor = Tensor::<B, 1>::from_floats(x_cheb.as_slice(), device)
//     // .reshape([90, 1]);

//     // let f_true = source_function::<B>(&x_cheb);

//     // let f_true = source_function::<B>(&x_cheb_points);
...
//     let d2_tensor = Tensor::<Autodiff<B>, 2>::from_floats(d2.as_slice().unwrap(), &device)
//     .reshape([n, n]);  
...
//         println!("1");
//         let x_tensor = cheb_points_tensor::<Autodiff<B>>(&device, n);
//         println!("dims before reshape: {:?}", x_tensor.dims());
//         let x_tensor = x_tensor.reshape([n, 1]);
